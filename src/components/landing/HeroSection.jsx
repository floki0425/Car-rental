...
function HeroSection({ children, heroImage, heroHighlights }) {
  return (
    <section className="relative isolate overflow-hidden bg-black text-white">
      ...
      <div className="container-shell relative z-10 flex min-h-[780px] flex-col justify-center pb-8 pt-24 sm:min-h-[820px] sm:pb-10 sm:pt-28 lg:min-h-[750px] lg:pb-12">
        <div className="max-w-2xl">
          <p className="text-[0.65rem] font-black uppercase tracking-[0.32em] text-gray-300">Elevated Travel Experience</p>
          <h1 className="mt-5 max-w-xl text-4xl font-black leading-[0.96] tracking-[-0.05em] text-white sm:text-6xl lg:text-6xl">
            Drive Comfortably Arrive Confidently
          </h1>
